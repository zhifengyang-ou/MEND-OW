...
! Created on February 26, 2013, 9:30 AM
    ...
    INTEGER, PARAMETER:: const_nVAR0        = 40                    !# of variables for calibration
...
!         INTEGER iKinetics                 !decomposition kinetics: 0-Michaelis-Menten, 1-First Order, 2-Second Order
         ...
         REAL(8) KsNH4_VG                   ![mg N/cm3], half-saturation constant for NH4 uptake by MBA ! by plant yzf 
         REAL(8) KsNO3_VG                   ![mg N/cm3], half-saturation constant for NO3 uptake by MBA ! by plant yzf
